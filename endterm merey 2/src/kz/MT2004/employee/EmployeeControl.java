...
import kz.MT2004.employee.specialty.Driver;
import kz.MT2004.employee.specialty.*;
...
public class EmployeeControl {
    ...
    public ArrayList<Employee> Hiredates()  {
        ...
        try {
            ...
            while(rs.next()) {//while there are fields in table
                //saving in object of Employee values (polymorphism)
    ...
    public void Quit_Date(String First_name, String Last_name) {
        ...
        try {
            ...
            String sql = "Update employee set quit_date = ? where first_name = '" + First_name + "' and last_name  = '" + Last_name +"'; ";
    ...
    public void UpdateSalary(int salary, String First_name, String Last_name) { //method that changes salary of concrete employee
        Connection con = null;//connection
        try {
            con = db.getConnection();//getting connection to database
    ...
    public void UpdateGender(String First_name, String Last_name, String new_gender) { //method that changes gender of inputted employee
        Connection con = null;//connection
        try {
            con = db.getConnection();//getting connection to database
